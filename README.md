    ...
    def _generate_report_and_advice(self):
        ...
        if self.leftover > 0:
            ...
            if self.leftover < recommended_savings:
                print("⚠️ Warning: Your current leftover amount is less than the 20% savings target. Consider reducing entertainment or other flexible expenses.")
            else:
                 print("Good job! You meet the 20% savings target.")

        elif self.leftover == 0:
            print("⚠️ Caution: You are breaking even. Try lowering some non-essential expenses to save money.")
        else:
